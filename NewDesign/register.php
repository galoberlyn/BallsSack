            ...
            <form method="POST" class="form-horizontal">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="LastName" class="form-control" name="password2" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label">
			...
			if(isset($_POST['username'])){
				if(isset($_POST['submit'])){
					...
					if($_POST['password'] == $_POST['password2']){
						$userSql = "INSERT into users(username, password, created_at, updated_at) values ('$userName', '$password', now(), now())";
						if(mysqli_query($conn, $userSql)){
							$user_id = mysqli_insert_id($conn);
							$userDetSql = "INSERT into user_details(user_id, firstname, lastname, created_at, updated_at) values ('$user_id', '$firstName', '$lastName', now(), now())";
							if(mysqli_query($conn, $userDetSql)){ 	
